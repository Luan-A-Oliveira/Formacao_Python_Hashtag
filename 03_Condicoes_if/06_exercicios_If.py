...
if vendas_funcionario1 >= meta_de_vendas:
    bonus = vendas_funcionario1 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('Bonus do funcionario é de: 0')

if vendas_funcionario2 >= meta_de_vendas:
    bonus = vendas_funcionario2 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('Bonus do funcionario é de: 0')

if vendas_funcionario3 >= meta_de_vendas:
    bonus = vendas_funcionario3 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('BBonus do funcionario é de: 0')
...
if vendas_funcionario1 >= 2000:
    ...
    print(f'Bonus do funcionario é de: {bonus}')
elif vendas_funcionario1 >= meta_de_vendas:
    bonus = vendas_funcionario1 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('Bonus do funcionario é de: 0')
...
if vendas_funcionario2 >= 2000:
    ...
    print(f'Bonus do funcionario é de: {bonus}')
elif vendas_funcionario2 >= meta_de_vendas:
    bonus = vendas_funcionario2 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('Bonus do funcionario é de: 0')
...
if vendas_funcionario3 >= 2000:
    ...
    print(f'Bonus do funcionario é de: {bonus}')
elif vendas_funcionario3 >= meta_de_vendas:
    bonus = vendas_funcionario3 * 0.10
    print(f'Bonus do funcionario é de: {bonus}')
else:
    print('Bonus do funcionario é de: 0')
